...
public class DataLoader {
    ...
    @Bean
    CommandLineRunner loadData(RestaurantRepository restaurantRepo, MealRepository mealRepo, ReservationRepository reservationRepo) {
        return args -> {
            ...
            reservationRepo.save(new Reservation("João Silva", "2024001", mealRepo.findAll().get(0)));
        };
    }
}
